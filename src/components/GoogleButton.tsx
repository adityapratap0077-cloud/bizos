...
/** Official Google "G" mark (multi-colour). Never an emoji. */
...
/**
 * "Continue with Google" in the Ledger design language:
 * ink-outline secondary button, full width, 48px touch target, pine focus ring.
 */
